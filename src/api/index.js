import { get, post, put, apiDelete } from './httpHandlers'
...
export const deleteShoppingItem = async (shoppingListId, itemId) => {
    console.log('deleteShoppingItem', shoppingListId, itemId)
    const response = await apiDelete(`${shoppingListId}/${itemId}`)
    return response
}